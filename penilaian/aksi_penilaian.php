...
if (isset($_POST['simpan'])) {
 ...
 for ($i=0; $i <$jumlah ; $i++) { 
  ...
  $fix_id_siswa= $_POST[$temp_id_siswa];
  ...
  if (mysqli_num_rows($hasil)<=0) {
   $sql="insert into tbl_nilai(id_siswa,c1,c2,c3,c4) values('$fix_id_siswa','$fix_c1','$fix_c2','$fix_c3','$fix_c4')";
